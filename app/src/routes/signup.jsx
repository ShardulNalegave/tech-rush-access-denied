								...
								<div className="grid grid-cols-1 gap-4">
									<div className="relative">
										...
										<input
											...
											className="pl-8 pr-3 py-2 w-full rounded-md border-b-2 border-gray-300 focus:border-yellow-500 ring-inset ring-gray-300 focus:ring-1 focus:ring-inset focus:outline-none transition duration-300"
											required
										/>
									</div>
									<div className="relative">
