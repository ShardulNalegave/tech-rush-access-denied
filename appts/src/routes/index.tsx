			...
			<div className="h-full max-w-screen snap-start">
				<div className="bg-cyan-100 h-full max-w-[100vw] items-center justify-center flex">
					<div className=" lg:flex-1">
						<img
							src="/imgs/1.jpg"
							className="h-[70vh] w-[19vw] z-[10] rounded-3xl object-cover shadow-2xl drop-shadow-2xl shadow-slate-900 relative top-[34rem] left-[260px] hidden lg:block"
							alt=""
						/>
						<img
							src="/imgs/8.jpg"
						...
						<img
							src="/imgs/9.jpg"
							className="h-[30vh] w-[14vw] object-cover shadow-2xl drop-shadow-2xl shadow-slate-900 rounded-3xl relative bottom-[830px] left-28 hidden lg:block"
							alt=""
						/>
					</div>
